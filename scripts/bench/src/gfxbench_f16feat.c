...
#include "gfxbench_f16_frag_spv.h"
...
int main(int argc,char**argv){
  ...
  const char* exts[]={"VK_KHR_shader_float16_int8"};
  VkDeviceCreateInfo dci={.sType=VK_STRUCTURE_TYPE_DEVICE_CREATE_INFO,.pNext=&f16,.queueCreateInfoCount=1,.pQueueCreateInfos=&qci,.enabledExtensionCount=1,.ppEnabledExtensionNames=exts};
